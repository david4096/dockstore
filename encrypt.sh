...
CUSTOM_DIR_NAME=updated_tokens_same_for_testing
...
ENCRYPT_FILE_CONTENTS=`travis encrypt-file --print-key $GIT_DIR/secrets.tar -r ga4gh/dockstore`

echo 'Please update CircleCI with the new environment variables above manually'
